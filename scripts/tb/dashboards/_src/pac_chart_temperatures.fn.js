...
html += '<div class="chart-title-bar"><span class="chart-title">Températures</span></div>';
...
setTimeout(function() {
    ...
    // __PAC_SPLIT_V1__ : cache partage — les charts de la page fetchent le
