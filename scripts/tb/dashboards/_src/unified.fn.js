...
function buildGauge(id,label,value,tempLabel,tempValue,min,max,color,colorLight){
  ...
  return '<div style="display:flex;flex-direction:column;align-items:stretch;background:#fff;border:1px solid #e0e0e0;border-radius:6px;padding:8px;box-sizing:border-box;flex:0 0 auto;width:235px">'+
    ...
    '<div style="display:flex;flex-direction:column;align-items:center;gap:6px">'+
      '<svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet" style="width:100%;max-width:220px;height:auto;display:block;margin:0 auto">'+
